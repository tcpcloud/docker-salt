...
### XXX
RUN rm -rf /usr/share/salt-formulas/env/nova
RUN git clone https://github.com/pupapaik/salt-formula-nova.git nova; mv nova/nova /usr/share/salt-formulas/env/
### XXX
